...
- [ ] 功能测试文件：`tests/acceptance/test_story_1.14b.feature`（由 Dev agent 在 Task 0 创建）
- [ ] 覆盖场景:
...
│   └── acceptance/
│       ├── test_story_1.14b.feature
│       └── test_story_1.14b_steps.py
└── docs/
    └── developer/
...
- `tests/acceptance/test_story_1.14b.feature` - Gherkin 验收测试（由 Dev agent 在 Task 0 创建）
- `tests/acceptance/test_story_1.14b_steps.py` - 验收测试步骤实现（由 Dev agent 在 Task 0 创建）
