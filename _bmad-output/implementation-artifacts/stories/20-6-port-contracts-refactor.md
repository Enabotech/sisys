...
**功能测试文件：** `tests/acceptance/test_story_20_6.feature`
...
| **TDD 验收测试** | Gherkin 场景 | 业务价值验收 | `test_story_20_6.feature` | Task 0 |
| **TDD 验收测试** | BDD 步骤实现 | 步骤函数实现 | `test_story_20_6_steps.py` | Task 0 |
...
- `tests/acceptance/test_story_20_6.feature` - Gherkin 场景
- `tests/acceptance/test_story_20_6_steps.py` - BDD 步骤实现
