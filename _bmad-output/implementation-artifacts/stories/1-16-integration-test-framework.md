...
| **TDD 验收测试** | Gherkin 场景 | 业务价值验收 | `test_story_1_16.feature` | Task 0 |
...
|----|-------------|-----------|-------------|----------|
| AC-1 | 集成测试框架基础设施就绪 | Task 0 | SDD 规范定义（策略、Mock、数据生命周期） | `test_story_1_16.feature` |
...
- [ ] Subtask: 编写 Gherkin 验收测试 `tests/acceptance/test_story_1_16.feature`
...
│   └── acceptance/
│       └── test_story_1_16.feature     # Gherkin 验收测试
├── src/
