...
- [ ] 功能测试文件：`tests/acceptance/test_acceptance_k8s_auto_scaling.feature`
- [ ] 覆盖场景:
...
| **TDD 验收测试** | Gherkin 场景 | 业务价值验收 | `test_acceptance_k8s_auto_scaling.feature` | Task 0 |
...
- [x] Subtask 0.7: 编写 Gherkin 验收测试 `tests/acceptance/test_acceptance_k8s_auto_scaling.feature`
...
└── tests/
    ...
    └── acceptance/
        └── test_acceptance_k8s_auto_scaling.feature
```
...
- `tests/acceptance/test_acceptance_k8s_auto_scaling.feature` - Gherkin 验收测试
- `tests/acceptance/test_acceptance_k8s_auto_scaling.py` - 验收测试步骤实现
