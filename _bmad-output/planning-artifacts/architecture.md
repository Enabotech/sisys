...
13. [完整目录结构](#13-完整目录结构)
14. [工具箱架构设计](#14-工具箱架构设计)
15. [质量属性设计](#15-质量属性设计)
16. [风险缓解措施](#16-风险缓解措施)
17. [MVP 范围与演进路线](#17-mvp-范围与演进路线)
...
| 工具类别 | 工具名称 | 描述 |
|---------|---------|------|
| **环境分析** | PESTEL 分析 | 宏观环境六维度分析 |
| | 波特五力 | 行业竞争结构分析 |
| | $APPEALS | 客户需求分析框架 |
| **竞争分析** | 竞争对手分析 | 竞争对手画像与策略分析 |
| | 价值链分析 | 企业价值创造环节分析 |
| | VRIO 框架 | 资源竞争力评估 |
| **战略选择** | 安索夫矩阵 | 增长战略选择 |
| | SWOT-TOWS 分析 | 内外因素匹配分析 |
| | GE-麦肯锡矩阵 | 业务组合评估 |
| | SPACE 矩阵 | 战略定位分析 |
| | 情景规划 | 多情景推演 |
| | 价值曲线分析 | 差异化战略分析 |
...
#### 19.2.3 工具标准工作流（Think→Code→Execute→Observe→Validate）
...
| **M13** | CUSUM 漂移检测算法缺失 | P1 | ✅ 已解决 | 第 15.4 节 |
| **M14** | 23 种工具完整列表 | P2 | ✅ 已修正 | 第 14.1 节 |
