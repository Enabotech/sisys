...
- FR-SP-13: 通过 REST API 提供财务量化分析（NPV/IRR/现金流），NPV/IRR 计算准确率 100%
...
| PERF-05 | 压力测试 | Checkpoint 恢复<60 秒 | Story 6.5a | 季度 | <60 秒 |
...
| REL-04 | 灾备演练 | Checkpoint 恢复成功率≥90% | Story 6.5a | 季度 | ≥90% |
...
| **Epic 5: Agent 协作系统** | 单 Agent 战略规划能力 | Story 1.4/1.10/1.18b | - | - | 顺序依赖（工作流） | ✅ 是 | 10 |
| **Epic 6: 战略规划流程** | 战略规划与审批能力<br/>UX 三视图<br/>**白标报告基础** | Story 1.4/1.7/1.18b | Story 2.2a/2.3 | Story 3.8 | 顺序依赖（BLM 流程） | ✅ 是 | **12** |
