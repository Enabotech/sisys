...
| Epic ID | Epic 名称 | 描述 | 包含 FRs |
|--------|---------|------|---------|
| **EPIC-01** | 基础设施与架构 | 六边形架构基础、五层存储、事件驱动、领域实体 | AR-01~04, SA-01~03 |
| **EPIC-02** | 文档与数据管理 | 17 种格式上传解析、版本管理、语义分块、高保真溯源 | DM-01~15, SR-08 |
| **EPIC-03** | 智能检索与知识发现 | 混合检索、分层检索、知识图谱、GraphRAG | SR-01~07, SR-09~15 |
| **EPIC-04** | 战略工具箱 | 23 种战略工具注册、编排、沙箱执行、版本管理 | ST-01~11 |
| **EPIC-05** | Agent 协作 | 单 Agent 执行、多 Agent 协作、EIP 隔离、SYS 裁决 | AC-01~16 |
| **EPIC-06** | 战略规划流程 | BLM 六阶段、BEM 六阶段、Checkpoint、Time-Travel | SP-01~12 |
| **EPIC-07** | 用户交互与报告 | CLI/API、报告生成、高管仪表盘、分支管理 | UI-01~13 |
| **EPIC-08** | 系统管理与合规 | RBAC、审计日志、等保 2.0、SOX/ISO 合规 | SC-01~14 |
| **EPIC-10** | 集成与生态 | API 网关、企业系统集成、外部数据源、MCP/A2A 协议 | 集成 NFRs |
...
### MVP 阶段 (8 周) - 66 项 P0 功能

| Epic | Stories | 数量 | FRs | NFRs | AFRs | 核心交付 |
|------|---------|------|-----|------|------|---------|
| **EPIC-01** | 1.1-1.12 | 12 | AR-01~04<br>SA-01~03 | NFR-SCALE-04<br>NFR-INT-05 | AFR-ARC-01~03<br>AFR-ARC-09 | 六边形架构、五层存储、事件驱动、领域实体 |
| **EPIC-02** | 2.1-2.7 | 7 | DM-01~08<br>SR-08 | NFR-PERF-01<br>NFR-COMP-03 | AFR-UX-02 | 17 种格式上传解析、高保真溯源 |
| **EPIC-03** | 3.1-3.8 | 8 | SR-01~08 | NFR-PERF-01/02/07 | AFR-ARC-09 | 混合检索、分层检索、知识图谱 |
| **EPIC-04** | 4.1-4.6 | 6 | ST-01~05 | NFR-SEC-07<br>NFR-INT-05 | AFR-ARC-09 | 工具注册、Docker 沙箱、红蓝辩论 |
| **EPIC-05** | 5.1-5.6 | 6 | AC-01~06 | NFR-SEC-05<br>NFR-REL-04 | AFR-ARC-05 | 单 Agent 执行、EIP 基础 |
| **EPIC-06** | 6.1<br>6.3-6.4<br>6.6 | 4 | SP-01~04 | NFR-REL-04 | AFR-ARC-08 | BLM 前两阶段、Checkpoint |
| **EPIC-07** | 7.1-7.7 | 7 | UI-01~07 | NFR-INT-01<br>NFR-PERF-03 | AFR-UX-04 | CLI/API、报告生成、高管仪表盘 |
| **EPIC-08** | 8.1-8.8 | 8 | SC-01~08 | NFR-COMP-01~05<br>NFR-SEC-01~07 | AFR-ARC-09 | RBAC、审计日志、等保 2.0 |
| **EPIC-09** | 9.1-9.2<br>9.4<br>9.8-9.9 | 5 | CP-01~04 | NFR-PERF-06<br>NFR-REL-06 | AFR-ARC-09 | 路由日志、语义缓存、健康度仪表盘 |
| **EPIC-10** | 10.1-10.3 | 3 | 集成 NFRs | NFR-INT-01/04/05 | AFR-ARC-09 | API 网关、OA 集成、外部数据源 |
| **MVP 总计** | | **66** | **58** | **24** | **8** | |

---

### V1 阶段 (3-6 个月) - 17 项 P1 功能

| Epic | Stories | 数量 | FRs | NFRs | AFRs | 核心交付 |
|------|---------|------|-----|------|------|---------|
| **EPIC-01** | - | 0 | - | - | - | - |
| **EPIC-02** | 2.8 | 1 | DM-09~12 | NFR-PERF-07 | AFR-UX-02 | 复杂表格处理 |
| **EPIC-03** | 3.9 | 1 | SR-09~13 | NFR-PERF-07 | AFR-ARC-09 | 知识图谱、GraphRAG |
| **EPIC-04** | 4.7 | 1 | ST-06~09 | NFR-INT-05 | AFR-ARC-09 | 财务建模 |
| **EPIC-05** | 5.7-5.9 | 3 | AC-07~14 | NFR-SCALE-03 | AFR-ARC-05<br>AFR-ARC-07 | 多 Agent 协作、SYS 裁决 |
| **EPIC-06** | 6.2<br>6.5<br>6.7 | 3 | SP-05~10 | NFR-REL-04 | AFR-ARC-08 | 完整 BLM 六阶段、双模式恢复 |
| **EPIC-07** | 7.8 | 1 | UI-08~12 | NFR-ACC-01/02 | AFR-UX-01<br>AFR-UX-04 | 无障碍、多语言 |
| **EPIC-08** | 8.9 | 1 | SC-09~12 | NFR-COMP-06/07 | AFR-ARC-06 | SOX/ISO 合规 |
| **EPIC-09** | 9.3<br>9.5-9.7 | 4 | CP-05~10 | NFR-PERF-06<br>NFR-REL-05/06 | AFR-ARC-04 | UDMR 路由、成本熔断、CUSUM |
| **EPIC-10** | 10.4-10.5 | 2 | 集成 NFRs | NFR-INT-02/03 | AFR-ARC-09 | ERP/CRM 集成、MCP/A2A 协议 |
| **V1 总计** | | **17** | **17 项 P1** | **12 项** | **10 项** | |

---

### V2 阶段 (6-12 个月) - 11 项 P2 功能

| Epic | Stories | 数量 | FRs | NFRs | AFRs | 核心交付 |
|------|---------|------|-----|------|------|---------|
| **EPIC-01** | - | 0 | - | - | - | - |
| **EPIC-02** | 2.9-2.10 | 2 | DM-13~15 | NFR-PERF-07 | AFR-UX-02<br>AFR-UX-05 | 跨模态检索、音视频转录 |
| **EPIC-03** | - | 0 | - | - | - | - |
| **EPIC-04** | 4.8 | 1 | ST-10~11 | NFR-SEC-07 | AFR-ARC-09 | gVisor 沙箱、压力测试 |
| **EPIC-05** | 5.10 | 1 | AC-15~16 | NFR-SCALE-03 | AFR-ARC-05 | Agent 扩缩容 |
| **EPIC-06** | 6.8-6.9 | 2 | SP-11~12 | NFR-REL-04 | AFR-ARC-08 | BEM 战略解码、SP→BP 闭环 |
| **EPIC-07** | 7.9 | 1 | UI-13 | NFR-PERF-03 | AFR-UX-05 | 决策影响分析 |
| **EPIC-08** | 8.10 | 1 | SC-13~14 | NFR-COMP-08/09 | AFR-ARC-06 | ISO 27001、银保监会规范 |
| **EPIC-09** | 9.10-9.11 | 2 | CP-11~12 | NFR-REL-05 | AFR-ARC-09 | 区块链哈希链、UEBA |
| **EPIC-10** | 10.6 | 1 | 集成 NFRs | NFR-INT-02 | AFR-ARC-09 | 生态集成 |
| **V2 总计** | | **11** | **11 项 P2** | **8 项** | **5 项** | |
...
|------|-----|------|------|---------|------|
| **MVP** | 66 项 P0 | 28 项 | 15 项 | 66 | 70% |
| **V1** | 17 项 P1 | 12 项 | 10 项 | 17 | 18% |
| **V2** | 11 项 P2 | 8 项 | 5 项 | 11 | 12% |
| **P3 排除** | 1 项 (SA-10) | - | - | - | - |
| **总计** | **122 项** | **40 项** | **30 项** | **94** | 100% |

**审核验证（两遍）：**
- **按版本加总：** 66 + 17 + 11 = 94 ✓
- **按 Epic 加总：** 12+10+9+8+10+9+9+10+11+6 = 94 ✓
...
|------|---------|------|-----|------|------|---------|
| **MVP** | 1.1-1.12 | 12 | AR-01~04<br>SA-01~03 | NFR-SCALE-04<br>NFR-INT-05 | AFR-ARC-01~03<br>AFR-ARC-09 | 六边形架构、五层存储、事件驱动、领域实体 |
| **V1** | - | 0 | - | - | - | - |
| **V2** | - | 0 | - | - | - | - |
| **总计** | - | **12** | **7** | **2** | **4** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 2.1-2.7 | 7 | DM-01~08<br>SR-08 | NFR-PERF-01<br>NFR-COMP-03 | AFR-UX-02 | 17 种格式上传解析、高保真溯源 |
| **V1** | 2.8 | 1 | DM-09~12 | NFR-PERF-07 | AFR-UX-02 | 复杂表格处理 |
| **V2** | 2.9-2.10 | 2 | DM-13~15 | NFR-PERF-07 | AFR-UX-02<br>AFR-UX-05 | 跨模态检索、音视频转录 |
| **总计** | - | **10** | **15** | **3** | **3** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 3.1-3.8 | 8 | SR-01~08 | NFR-PERF-01/02/07 | AFR-ARC-09 | 混合检索、分层检索、知识图谱 |
| **V1** | 3.9 | 1 | SR-09~13 | NFR-PERF-07 | AFR-ARC-09 | 知识图谱、GraphRAG |
| **V2** | - | 0 | - | - | - | - |
| **总计** | - | **9** | **13** | **4** | **2** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 4.1-4.6 | 6 | ST-01~05 | NFR-SEC-07<br>NFR-INT-05 | AFR-ARC-09 | 工具注册、Docker 沙箱、红蓝辩论 |
| **V1** | 4.7 | 1 | ST-06~09 | NFR-INT-05 | AFR-ARC-09 | 财务建模 |
| **V2** | 4.8 | 1 | ST-10~11 | NFR-SEC-07 | AFR-ARC-09 | gVisor 沙箱、压力测试 |
| **总计** | - | **8** | **11** | **3** | **3** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 5.1-5.6 | 6 | AC-01~06 | NFR-SEC-05<br>NFR-REL-04 | AFR-ARC-05 | 单 Agent 执行、EIP 基础 |
| **V1** | 5.7-5.9 | 3 | AC-07~14 | NFR-SCALE-03 | AFR-ARC-05<br>AFR-ARC-07 | 多 Agent 协作、SYS 裁决 |
| **V2** | 5.10 | 1 | AC-15~16 | NFR-SCALE-03 | AFR-ARC-05 | Agent 扩缩容 |
| **总计** | - | **10** | **16** | **3** | **4** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 6.1<br>6.3-6.4<br>6.6 | 4 | SP-01~04 | NFR-REL-04 | AFR-ARC-08 | BLM 前两阶段、Checkpoint |
| **V1** | 6.2<br>6.5<br>6.7 | 3 | SP-05~10 | NFR-REL-04 | AFR-ARC-08 | 完整 BLM 六阶段、双模式恢复 |
| **V2** | 6.8-6.9 | 2 | SP-11~12 | NFR-REL-04 | AFR-ARC-08 | BEM 战略解码、SP→BP 闭环 |
| **总计** | - | **9** | **12** | **3** | **3** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 7.1-7.7 | 7 | UI-01~07 | NFR-INT-01<br>NFR-PERF-03 | AFR-UX-04 | CLI/API、报告生成、高管仪表盘 |
| **V1** | 7.8 | 1 | UI-08~12 | NFR-ACC-01/02 | AFR-UX-01<br>AFR-UX-04 | 无障碍、多语言 |
| **V2** | 7.9 | 1 | UI-13 | NFR-PERF-03 | AFR-UX-05 | 决策影响分析 |
| **总计** | - | **9** | **13** | **4** | **4** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 8.1-8.8 | 8 | SC-01~08 | NFR-COMP-01~05<br>NFR-SEC-01~07 | AFR-ARC-09 | RBAC、审计日志、等保 2.0 |
| **V1** | 8.9 | 1 | SC-09~12 | NFR-COMP-06/07 | AFR-ARC-06 | SOX/ISO 合规 |
| **V2** | 8.10 | 1 | SC-13~14 | NFR-COMP-08/09 | AFR-ARC-06 | ISO 27001、银保监会规范 |
| **总计** | - | **10** | **14** | **9** | **3** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 9.1-9.2<br>9.4<br>9.8-9.9 | 5 | CP-01~04 | NFR-PERF-06<br>NFR-REL-06 | AFR-ARC-09 | 路由日志、语义缓存、健康度仪表盘 |
| **V1** | 9.3<br>9.5-9.7 | 4 | CP-05~10 | NFR-PERF-06<br>NFR-REL-05/06 | AFR-ARC-04 | UDMR 路由、成本熔断、CUSUM |
| **V2** | 9.10-9.11 | 2 | CP-11~12 | NFR-REL-05 | AFR-ARC-09 | 区块链哈希链、UEBA |
| **总计** | - | **11** | **12** | **5** | **3** | - |
...
| 版本 | Stories | 数量 | FRs | NFRs | AFRs | 核心功能 |
|------|---------|------|-----|------|------|---------|
| **MVP** | 10.1-10.3 | 3 | 集成 NFRs | NFR-INT-01/04/05 | AFR-ARC-09 | API 网关、OA 集成、外部数据源 |
| **V1** | 10.4-10.5 | 2 | 集成 NFRs | NFR-INT-02/03 | AFR-ARC-09 | ERP/CRM 集成、MCP/A2A 协议 |
| **V2** | 10.6 | 1 | 集成 NFRs | NFR-INT-02 | AFR-ARC-09 | 生态集成 |
| **总计** | - | **6** | **6** | **5** | **3** | - |
