...
@scenario("test_acceptance_integration_test_framework.feature", "集成测试目录结构就绪")
...
@scenario("test_acceptance_integration_test_framework.feature", "外部服务 Mock 配置")
...
@scenario("test_acceptance_integration_test_framework.feature", "领域事件冒烟测试")
...
@scenario("test_acceptance_integration_test_framework.feature", "事件类型注册表 — 未知类型反序列化")
...
@scenario("test_acceptance_integration_test_framework.feature", "幂等性检查原子操作")
...
@scenario("test_acceptance_integration_test_framework.feature", "重试机制指数退避")
...
@scenario("test_acceptance_integration_test_framework.feature", "仓储模式冒烟测试")
...
@scenario("test_acceptance_integration_test_framework.feature", "测试数据生命周期管理")
...
@scenario("test_acceptance_integration_test_framework.feature", "应用层→领域层→基础设施层协作")
...
@scenario("test_acceptance_integration_test_framework.feature", "错误传播")
