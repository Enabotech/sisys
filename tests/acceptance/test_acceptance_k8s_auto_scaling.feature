...
功能: Story 1.13 - K8s 动态扩缩容
  ...
  场景: AC-3 - K8s HPA 基于自定义指标扩缩容
    ...
    并且 Prometheus Adapter 已部署（将 Prometheus 指标转换为 External Metrics）
    当 K8s HPA 基于自定义指标配置
