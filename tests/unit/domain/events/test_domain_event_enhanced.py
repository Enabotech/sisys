...
class TestDomainEventEnhancement:
    ...
    def test_domain_event_has_correlation_id_field(self):
    ...
    def test_domain_event_has_causation_id_field(self):
        """DomainEvent should have causation_id field as UUID | None."""
        event = DomainEvent(event_type="TestEvent")
        assert hasattr(event, "causation_id")
        assert event.causation_id is None

    def test_domain_event_has_metadata_field(self):
    ...
    def test_domain_event_accepts_correlation_id(self):
    ...
    def test_domain_event_accepts_causation_id(self):
    ...
    def test_domain_event_accepts_metadata(self):
    ...
    def test_to_dict_excludes_none_values_for_traceability_fields(self):
    ...
    def test_from_dict_restores_causation_id(self):
    ...
    def test_backward_compatibility_existing_subclass(self):
    ...
    def test_backward_compatibility_from_dict_without_new_fields(self):
