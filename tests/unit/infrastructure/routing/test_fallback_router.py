...
class TestFallbackRouter:
    ...
    @pytest.mark.asyncio
    async def test_returns_fallback_when_primary_unhealthy(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_fallback_when_timeout_exceeded(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_primary_when_within_timeout(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_injects_health_checker_via_constructor(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_route_includes_task_id(self) -> None:
        ...
        result = await router.route("test-task-123", primary_model="qwen2.5:7b", fallback_model="qwen-turbo")
        assert result == "qwen2.5:7b"
