...
- [ ] 测试覆盖 — 构造/`to_dict()`/HTTP 映射/编码唯一性测试通过（测试规范详见 `sisys-uni-exception-design.md §3.12`，活文档参考 `tests/unit/domain/exceptions/test_base_exceptions.py` + `tests/unit/interfaces/api/test_exception_handlers.py`）
