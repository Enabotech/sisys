...
┌─────────────────────────────────────────────────────────────────┐
│                        Gitea (代码托管)                          │
│  仓库：https://gitea.sisys.local/sisys/sisys.git                │
...
┌─────────────────────────────────────────────────────────────────┐
│                    ArgoCD (持续部署)                             │
│  地址：argocd.sisys.local                                       │
│  配置：./developments/apps/sisys/                               │
│  应用：sisys-app-dev, sisys-app-test, sisys-app-prod            │
└─────────────────────────────────────────────────────────────────┘
                              │
                              │ 4. 同步部署
                              ▼
